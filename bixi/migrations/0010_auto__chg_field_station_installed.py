...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Station.installed'
        db.alter_column(u'bixi_station', 'installed', self.gf('django.db.models.fields.NullBooleanField')(null=True))

    def backwards(self, orm):

        # Changing field 'Station.installed'
        db.alter_column(u'bixi_station', 'installed', self.gf('django.db.models.fields.BooleanField')())
