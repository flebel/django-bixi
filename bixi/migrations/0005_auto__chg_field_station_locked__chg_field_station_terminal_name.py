...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Station.locked'
        db.alter_column(u'bixi_station', 'locked', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Station.terminal_name'
        db.alter_column(u'bixi_station', 'terminal_name', self.gf('django.db.models.fields.CharField')(max_length=50))

    def backwards(self, orm):

        # Changing field 'Station.locked'
        db.alter_column(u'bixi_station', 'locked', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Station.terminal_name'
        db.alter_column(u'bixi_station', 'terminal_name', self.gf('django.db.models.fields.CharField')(max_length=10))
    ...
    models = {
        u'bixi.city': {
            ...
            'parser_type': ('django.db.models.fields.SmallIntegerField', [], {'default': '0'}),
