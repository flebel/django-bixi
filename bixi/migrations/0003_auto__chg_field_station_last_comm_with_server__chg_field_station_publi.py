...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Station.last_comm_with_server'
        db.alter_column(u'bixi_station', 'last_comm_with_server', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Station.public'
        db.alter_column(u'bixi_station', 'public', self.gf('django.db.models.fields.NullBooleanField')(null=True))

    def backwards(self, orm):

        # Changing field 'Station.last_comm_with_server'
        db.alter_column(u'bixi_station', 'last_comm_with_server', self.gf('django.db.models.fields.DateTimeField')(default=None))

        # Changing field 'Station.public'
        db.alter_column(u'bixi_station', 'public', self.gf('django.db.models.fields.BooleanField')())
