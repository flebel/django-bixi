...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Station.temporary'
        db.alter_column(u'bixi_station', 'temporary', self.gf('django.db.models.fields.NullBooleanField')(null=True))

    def backwards(self, orm):

        # Changing field 'Station.temporary'
        db.alter_column(u'bixi_station', 'temporary', self.gf('django.db.models.fields.BooleanField')())
